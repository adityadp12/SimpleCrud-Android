...
public class UpdateDeleteActivity extends ActionBarActivity {
    ...
    String url_update_mhs= "http://apicrud.myditya.my.id/simple_crud/update_mhs.php";
    String url_delete_mhs= "http://apicrud.myditya.my.id/simple_crud/delete_mhs.php";
